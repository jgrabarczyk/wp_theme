...
<head>
  ...
  <link
    href="<?=get_template_directory_uri();?>/assets/img/icons/favicon.ico"
    rel="shortcut icon">
  <link
    href="<?=get_template_directory_uri();?>/assets/img/icons/touch.png"
...
<body <?php body_class();?>>
  <header class="header" role="banner">
    <div class="header-container d-flex">
      ...
      <?php wp_theme_render_search_form($mobile_input_hidden = true);?>
